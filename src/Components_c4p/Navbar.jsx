  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 flex items-center justify-between">
        {/* Logo + Name */}
        <div className="flex items-center space-x-3 text-white font-bold transition-all duration-300">
          ...
          <li className="relative" ref={desktopDropdownRef}>
            ...
            {desktopDropdownOpen && (
              <ul className="absolute left-0 mt-2 w-48 bg-black shadow-lg text-white rounded z-50">
                <li className="px-4 py-2 hover:bg-green-600 cursor-pointer">score4change</li>
      ...
      {/* Mobile Nav */}
      {menuOpen && (
        <div className="fixed top-0 left-0 w-full h-screen bg-black text-white z-50 flex flex-col pt-6">
